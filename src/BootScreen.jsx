  ...
  return (
    <div className="boot-screen" style={{ background: `url('/assets/gnf-wallpaper-blue.webp')`, backgroundSize: 'cover' }}>
      <div className="boot-box">
        ...
        <p style={{ fontSize: '12px', color: '#888', marginTop: '14px', marginBottom: '0', fontFamily: '"Comic Sans MS", "Chalkboard SE", "Comic Neue", sans-serif' }}>Press spacebar to skip</p>
      </div>
    </div>
  );
}