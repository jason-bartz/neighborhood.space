...
export default function MobileLanding({ initialBootDone = false }) {
  ...
  // LP Grid component for reuse
  const LpGrid = ({ lps }) => (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: "15px", ...commonFontStyle }}>
      {lps.map(({ name, title, bio, linkedin }) => (
        <div key={name} style={{ background: "#f8f8ff", padding: "12px", borderRadius: "8px", border: "1px solid #ccc" }}>
          <img
          ...
          />
          <h3 style={{ marginBottom: "3px", fontSize: "14px", textAlign: "center" }}>
            {linkedin ? (
              <a 
                href={linkedin} 
                target="_blank" 
          ...
          <p style={{ fontWeight: "bold", marginBottom: "5px", fontSize: "12px", textAlign: "center" }}>{title}</p>
          <p style={{ fontSize: "11px", lineHeight: "1.3" }}>{bio}</p>
          {linkedin && <a href={linkedin} target="_blank" rel="noreferrer" style={{ display: "inline-block", marginTop: "5px", fontSize: "11px", color: "#3366cc" }}>LinkedIn</a>}
        </div>
      ))}
    </div>
  );
  ...
  const renderTabContent = () => {
    ...
    switch (currentPage) {
            ...
            <div style={{ 
              ...
              >
                ...
                <div style={{ display: "inline-flex", gap: "20px", padding: "0 10px" }}>
                  {[
                    { src: "/assets/Ernies2.webp", alt: "Ernie's Pop Shop, Micro-Grant Awardee" },
                    { src: "/assets/BFR2.webp", alt: "Buffalo Fashion Runway - Micro-Grant Awardee" },
                    { src: "/assets/Trinas2.webp", alt: "Trina's Speedy Cleaning, Micro-Grant Awardee" },
                    { src: "/assets/gnf-kamil.webp", alt: "Kamil Social, Micro-Grant Awardee" }
                  ].map((img, index) => (
                    <img 
        ...
        return (
          <div style={{ ...commonFontStyle, color: "#222", fontSize: "13px" }}>
            ...
            <div style={{ background: "#fff0f5", padding: "15px", border: "2px groove #cc88aa", borderRadius: "8px", textAlign: "center" }}>
              ...
              <button onClick={() => window.location.href = "https://airtable.com/app38xfYxu9HY6yT3/pagYPQAHYvAUxPfuX/form"} style={{ background: "#ffccee", border: "2px outset #ff99cc", borderRadius: "6px", padding: "8px 15px", fontWeight: "bold", fontSize: "12px", cursor: "pointer", marginTop: "10px" }}>✉️ Contact Us to Start a Chapter</button>
            </div>
          </div>
        );
      ...
      case "wny":
        return (
          <div style={{ ...commonFontStyle, color: "#222", fontSize: "13px" }}>
            <h2 style={{ fontSize: "18px" }}>Western New York Chapter LPs</h2>
            ...
            <div style={{ 
              ...
              <h3 style={{ color: "#FF8F00", margin: "0 0 8px 0", fontSize: "14px" }}>Become a Limited Partner</h3>
      ...
      case "denver":
        return (
          <div style={{ ...commonFontStyle, color: "#222", fontSize: "13px" }}>
            <h2 style={{ fontSize: "18px" }}>Denver Chapter LPs</h2>
    ...
    <div className="mobile-desktop" style={{
      ...
      <div className="mobile-taskbar" style={{
        ...
        <div className="taskbar-left" style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <img src="/favicon.png" alt="GNF" style={{ width: "16px", height: "16px" }} />
              ...
              <div style={{ 
                ...
                <button 
                  ...
                  style={{
                    padding: "6px 10px",
                    border: "none",
                    borderBottom: activeTab === "chapters" || activeTab === "wny" || activeTab === "denver" ? "3px solid #FFD6EC" : "3px solid transparent",
                    background: "transparent",
                    cursor: "pointer",
                    fontWeight: activeTab === "chapters" || activeTab === "wny" || activeTab === "denver" ? "bold" : "normal",
                    fontSize: "inherit",
                    fontFamily: "inherit"
                  }}
                >
