...
export default function LPRecruiting() {
  return (
    <>
      ...
      <p>
        Perfect. LPs aren't supposed to be investors — they're supposed to
        be neighbors. You rate pitches on gut, kindness, and local
      ...
      <p>
        ...
        round for a friend who's starting something — it's a gift, not an
        investment.
      </p>
      ...
      <blockquote className="resource-callout" style={{ background: 'var(--mb-paper)' }}>
        ...
        <p style={{ margin: 0 }}>
          ...
          weird idea — pool $500 from 10 friends, give $1,000 to a local
      ...
      <div className="resource-callout" style={{ background: 'var(--mb-paper)' }}>
        <p style={{ margin: 0 }}>
          ...
          swing.<br /><br />
          You came to mind because [specific reason — their network, their
          past company, their eye for talent]. I'd love to tell you more
          over coffee. 20 minutes, on me. This Thursday or next?<br /><br />
          [signature]
        </p>
      </div>
